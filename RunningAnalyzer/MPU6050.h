...
} MPU6050_Sensor_Values;

struct MPU6050 {
	
	struct MPU6050_Sensor_Values sensor_values;
	
	//Gyro offset not used in this impementation - Maybe in the future
	uint16_t gyroX_Offset;
	uint16_t gyroY_Offset;
	uint16_t gyroZ_Offset;
